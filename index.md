...
The goal of [coder](https://docs.ropensci.org/coder/) is to classify
items from one dataset, using codes from a secondary source with
classification schemes based on regular expressions and weighted
indices.
...
(i-iii) corresponds to the output from functions
...
which could be chained explicitly as
...
![plot of chunk
unnamed-chunk-5](reference/figures/READMEunnamed-chunk-5-1.png)
...
![plot of chunk
unnamed-chunk-8](reference/figures/READMEunnamed-chunk-8-1.png)
...
are based on regular expressions for computational speed (see
